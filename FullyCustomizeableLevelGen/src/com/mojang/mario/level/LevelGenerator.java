...
public class LevelGenerator
{
	...
	public static final int ENEMY_RED_KOOPA = 4;
	public static final int ENEMY_FLOWER = 5;
    ...
    private void addEnemyLine(int x0, int x1, int y)
    {
        for (int x = x0; x < x1; x++)
        {
            if (random.nextInt(35) < difficulty + 1)
            {
                ...
                level.setSpriteTemplate(x, y, type);
            }
        }
    }
    ...
    private int buildTubes(int xo, int maxLength)
    {
        ...
        for (int x = xo; x < xo + length; x++)
        {
            ...
            {
                level.setSpriteTemplate(x, tubeHeight, ENEMY_FLOWER);
            }
